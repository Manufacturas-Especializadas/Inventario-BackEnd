        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Folio = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false, computedColumnSql: "'PO-' + CONVERT(varchar(4), DATEPART(year, [OrderDate])) + '-' + RIGHT('000000' + CONVERT(varchar(20), [Id]), 6)", stored: true),
                    ...
                    ConfirmedDeliveryDate = table.Column<DateTime>(type: "date", nullable: false),
                    SupplierConfirmedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderedPurchaseQuantity = table.Column<int>(type: "int", nullable: false),
                    PurchaseUnitCost = table.Column<decimal>(type: "decimal(18,4)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseOrderItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchaseOrderItems_PPEProducts_PPEProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderItems_PPEProductId",
                table: "PurchaseOrderItems",
                column: "PPEProductId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderItems_PurchaseOrderId_PPEProductId",
                table: "PurchaseOrderItems",
                columns: new[] { "PurchaseOrderId", "PPEProductId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_Folio",
                table: "PurchaseOrders",
                column: "Folio",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_SupplierId_PurchaseOrderNumber",
                table: "PurchaseOrders",
                columns: new[] { "SupplierId", "PurchaseOrderNumber" },
                unique: true);
